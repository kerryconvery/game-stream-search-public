...
namespace GameSearchService.StreamProviders.Tests
{
    ...
    public class YouTubeStreamProviderTests
    {
        ...
        public async Task Should_Return_A_List_Of_Streams()
        {
            ...
            youTubeV3ApiStub.Setup(m => m.SearchGamingVideos("fake game", VideoEventType.Live, VideoSortType.ViewCount, "fake page token")).ReturnsAsync(liveStreams);
        ...
        public async Task Should_Return_As_Empty_List_Of_Streams_When_There_Is_An_Api_Error()
        {
            ...
            youTubeV3ApiStub.Setup(m => m.SearchGamingVideos(null, VideoEventType.Live, VideoSortType.ViewCount, null)).ReturnsAsync(new YouTubeSearchDto());
